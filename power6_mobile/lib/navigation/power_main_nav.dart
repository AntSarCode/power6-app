...
class PowerMainNav extends StatefulWidget {
  ...
  @override State<PowerMainNav> createState() => _PowerMainNavState();
}

class _PowerMainNavState extends State<PowerMainNav> {
  int _index = 0;
  final _screens = const [
    HomeScreen(), TaskInputScreen(), TaskReviewScreen(),
    TimelineScreen(), StreakScreen(), SubscriptionScreen(),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Power6'), backgroundColor: Colors.transparent, elevation: 0),
      body: Stack(children: [
